package com.pdfplatform.poc.extractor;

import com.pdfplatform.poc.model.TextBlock;
import com.pdfplatform.poc.model.TextBlock.EditabilityInfo;
...
public class TextBlockExtractor {
    ...
    public TextBlockExtractor(PDPage page) {
        this.page = page;
    }

    public List<TextBlock> extract(List<TextRun> runs) {
        ...
        for (List<TextRun> group : groups) {
            TextBlock block = buildBlock(group);
    ...
    private TextBlock buildBlock(List<TextRun> runs) {
        ...
        // Assess editability
        EditabilityInfo editability = assessEditability(first);
    ...
    private EditabilityInfo assessEditability(TextRun representative) {
